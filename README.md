![docker image](https://github.com/Bondoki/CRC1415-v1.4.3/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Bondoki/CRC1415-v1.4.3.git
    cd CRC1415-v1.4.3
    ```
    ...
    ```sh
    curl -L -o CRC1415-v1.4.3.zip "https://github.com/Bondoki/CRC1415-v1.4.3/archive/main.zip"
    unzip CRC1415-v1.4.3.zip
    cd CRC1415-v1.4.3
    ```
...
your `docker-compose.yaml` with `ghcr.io/bondoki/crc1415-v1.4.3:main` for the services
...
```sh
docker pull ghcr.io/bondoki/crc1415-v1.4.3/jupyter:main
```
...
- _I get an_ `Error response from daemon: Head "https://ghcr.io/v2/bondoki/crc1415-v1.4.3/manifests/main": unauthorized` _when trying to pull my docker image._
